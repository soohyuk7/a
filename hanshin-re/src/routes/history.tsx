...
export const Route = createFileRoute("/history")({
  head: () => ({
    meta: [
      { title: "연혁 — 한신부동산중개법인" },
      { name: "description", content: "한신부동산중개법인이 걸어온 길. 2005년 설립부터 현재까지의 주요 발자취." },
    ],
  }),
...
const EVENTS = [
  ...
  { year: "2005", items: ["한신부동산중개법인 설립", "강남구 역삼동 첫 빌딩 매매 성사"] },
];
...
function HistoryPage() {
  return (
    <PageShell
      eyebrow="History"
      title={<>한신이 <span className="italic">걸어온 길</span></>}
      intro="2005년 강남의 작은 사무실에서 시작된 한신은, 오늘날 강남 빌딩 매매를 대표하는 중개법인으로 성장했습니다."
    >
