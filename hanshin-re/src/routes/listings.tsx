...
function ListingsPage() {
  return (
    <PageShell
      ...
      title={<>엄선된 <span className="italic">전체 매물</span></>}
      intro="한신부동산중개법인이 직접 선별한 강남·서초·송파의 빌딩 매물. 입지, 유형, 가격대별로 자유롭게 탐색해 보세요."
    >
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-14">
        {LISTINGS.map((l, i) => (
          <Link key={i} to="/listings" className="group block">
