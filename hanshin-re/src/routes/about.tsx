...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "회사 소개 — 한신부동산중개법인" },
      { name: "description", content: "한신부동산중개법인은 서울 강남 빌딩 매매 전문 중개법인입니다." },
      { property: "og:title", content: "회사 소개 — 한신부동산중개법인" },
...
function AboutPage() {
  return (
    <PageShell
      ...
      intro="한신부동산중개법인은 서울 강남구를 중심으로 프라임 오피스와 수익형 빌딩의 매매를 전담하는 중개법인입니다."
    >
      <div className="grid lg:grid-cols-12 gap-12 items-center mb-32">
        ...
        <div className="lg:col-span-5">
          ...
          <p className="mt-6 text-muted-foreground leading-relaxed">
            한신은 빌딩을 단순한 거래 대상이 아닌 장기 자산으로 바라봅니다.
